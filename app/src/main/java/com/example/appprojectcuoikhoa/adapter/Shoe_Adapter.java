...
import com.example.appprojectcuoikhoa.activity.ChiTietSanPham;
...
public class Shoe_Adapter extends RecyclerView.Adapter<Shoe_Adapter.ShoeViewHolder>{
   ...
   private FavoriteDB favoriteDB;
    ...
    @Override
    public void onBindViewHolder(Shoe_Adapter.ShoeViewHolder holder, @SuppressLint("RecyclerView") int position) {
